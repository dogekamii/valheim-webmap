...
const expectedHash = "33c2b65512e71a0c05cbe1c2f89343605653e5f7fada91885ba756b12121b244";
...
const packagedHash = crypto.createHash("sha256").update(fs.readFileSync(path.join(output, "websocket-sharp.dll"))).digest("hex");
if (packagedHash !== expectedHash) fail("websocket-sharp.dll SHA-256 does not match the repository pin");
